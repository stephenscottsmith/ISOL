...
public class TitlesController {
	...
	public ResponseEntity<Title[]> getTitles() {
		Collection<Title> titles = titleService.findAll();
		
		return new ResponseEntity<Title[]>(titles.toArray(new Title[titles.size()]), HttpStatus.OK);
	}
